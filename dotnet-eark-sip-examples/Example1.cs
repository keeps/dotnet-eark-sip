...
/// <summary>
/// This example aims to show how to create an E-ARK SIP with multiple objects in a representation, using just a path to a folder with all elements.
/// In this example, one will use <c>RepresentationUtils</c>, in order to go through the whole folder and ingest all the files in it.
/// </summary>
/// <remarks>
